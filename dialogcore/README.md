...
graph TD
    ...
    G --> G1[<i class="fas fa-check"></i> Высокая вариативность — до 1344 синонимов]
    G --> G2[<i class="fas fa-check"></i> Сильный образовательный компонент — 80+ "Что такое..."]
    G --> G3[<i class="fas fa-check"></i> Поддержка навигации — внутренние ссылки, категории]
    G --> G4[<i class="fas fa-check"></i> Поддержка новичков — пошаговые инструкции]
    G --> G5[<i class="fas fa-check"></i> Готовность к росту — структура масштабируется]
    G --> G6[<i class="fas fa-check"></i> Гибкая кастомизация — синтаксис синонимов]
```
